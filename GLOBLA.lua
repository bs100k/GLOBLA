...
send(msg.chat_id_, msg.id_, 1, '🚫┇المجموعهہ‌‏ معطلهہ‌‏ سابقاً\n', 1, 'md')
else
...
------------------GPS AND USERS-------------------------------------------
if text:match("^الاحصائيات$") or text:match("^الكروبات$") and is_admin(msg.sender_user_id_, msg.chat_id_) then
...
send(msg.chat_id_, msg.id_, 1, "🧟‍♂️┇البوتات بالطرد مقفوله سابقا \n👤┇ الأمر بواسطه ← "..tmGlobla(msg).."\n ‏ ", 1, "md")
end
...
send(msg.chat_id_, msg.id_, 1, "🗂┇ الملفات مقفوله سابقا \n👤┇ الأمر بواسطه ← "..tmGlobla(msg).."\n ‏ ", 1, "md")
end
redis:set(GLOBLA.."bot:document:mute" .. msg.chat_id_, true)
end
...
send(msg.chat_id_, msg.id_, 1, "🤹‍♂️┇ الالعاب مقفوله سابقا \n👤┇ الأمر بواسطه ← "..tmGlobla(msg).."\n ‏ ", 1, "md")
end
...
send(msg.chat_id_, msg.id_, 1, "📥┇ الانضمام مقفوله سابقا \n👤┇ الأمر بواسطه ← "..tmGlobla(msg).."\n ‏ ", 1, "md")
end
...
send(msg.chat_id_, msg.id_, 1, "🧟‍♂️┇ البوتات بالطرد مفتوحه سابقا \n👤┇ الأمر بواسطه ← "..tmGlobla(msg).."\n ‏ ", 1, "md")
end
...
send(msg.chat_id_, msg.id_, 1, "🗂┇ الملفات مفتوحه سابقا \n👤┇ الأمر بواسطه ← "..tmGlobla(msg).."\n ‏ ", 1, "md")
end
redis:del(GLOBLA.."bot:document:mute" .. msg.chat_id_)
end
...
send(msg.chat_id_, msg.id_, 1, "🤹‍♂️┇ الالعاب مفتوحه سابقا \n👤┇ الأمر بواسطه ← "..tmGlobla(msg).."\n ‏ ", 1, "md")
end
...
send(msg.chat_id_, msg.id_, 1, "📥┇ الانضمام مفتوح سابقا\n👤┇ الأمر بواسطه ← "..tmGlobla(msg).."\n ‏ ", 1, "md")
end
...
if not redis:get(GLOBLA..'lock:add'..msg.chat_id_) then
local GLOBLA = {"انت نجب لاتندفر😒","هلمرة راح اغلس لخاطر المدير","فوگ مامخليك بالكروب تحجي"}
send(msg.chat_id_, msg.id_, 1,''..GLOBLA[math.random(#GLOBLA)]..'', 1, 'md')
end
end
------------------------------
