...
العالميWRITING THE SOURCE BY : @Globla

WRITING THE SOURCE BY : @Globla
CH SOURCE : @GLOBLA_CH
...
↬ [DevGlobla](t.me/DevGlobla)

↬ [Group Globla](t.me/joinchat/GLOSYU6g4O1BE8pkbS58cw)
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end end
