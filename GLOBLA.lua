...
redis:set(GLOBLA..'zaeony1'..msg.sender_user_id_..''..msg.chat_id_..'','zaeony2')
send(msg.chat_id_, msg.id_, 1, keep,1, 'md')
return false end end end
if text then
local Globla1 = redis:get(GLOBLA..'zaeony1'..msg.sender_user_id_..''..msg.chat_id_..'')
if Globla1 == 'zaeony2' then
if text == '1' then
...
redis:del(GLOBLA..'zaeony1'..msg.sender_user_id_..''..msg.chat_id_..'')
else
local numkep = tonumber(redis:get(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'') or 0 )
...
💠┇مرحبا انا بوت اسمي *(]]..(redis:get(GLOBLA..'Globlanams') or 'العالمي')..[[)🗼*
...
`git clone https://github.com/DevGlobla/GLOBLA.git && cd GLOBLA && chmod +x Globla && ./Globla`
...
💲┇ *قناٌة السوٰرس *≈ [@Globla](T.ME/Globla)
